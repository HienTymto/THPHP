<div class="container my-5">
  ...
  <footer class="bg-dark text-center text-lg-start text-white">
    ...
    <div class="container p-4">
      ...
      <div class="row my-4">
        ...
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
          ...
          <p class="text-center">Pet House là trại nhân giống cung cấp thú cảnh lớn tại Việt Nam.  </p>
        ...
        <!--Grid column-->
        <div class="col-lg-3 col-md-6 mb-4 mb-md-0">
          <h5 class="text-uppercase mb-4">CHÍNH SÁCH MUA BÁN</h5>
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
      abc
      <a class="text-white" href="#">Vũ Văn Hiến-Đỗ Hoàng Dũng</a>
    </div>
    <!-- Copyright -->
  </footer>
